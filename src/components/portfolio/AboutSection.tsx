...
export function AboutSection() {
  return (
    <section id="about" className="min-h-screen relative flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 scroll-mt-20">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto backdrop-blur-xl bg-white/[0.03] border border-white/10 rounded-[32px] md:rounded-[48px] p-8 sm:p-12 md:p-16 flex flex-col items-center gap-10 sm:gap-14 md:gap-16 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        <FadeIn delay={0} y={40}>
        ...
        <AnimatedText
          ...
          text="With more than 1.5 years of experience in video editing, i focus on storytelling, motion, and pacing, i truly enjoy working with businesses that aim to stand out and present their best image. Let's build something incredible together!"
        />
